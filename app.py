...
# Recupera dati da secrets.toml (non visibili nel codice sorgente)
...
authenticator = stauth.Authenticate(
    ...
    "signature_key_abc",     # personalizza la firma (metti stringhe lunghe e casuali)
